...
const Navbar = () => {
  return (
    <div className="bg-linear-to-b from-slate-700 to-slate-600 flex items-center justify-between p-4 shadow-xl">
        {/* search bar */}
        <div className="hidden md:flex items-center gap-2 text-xs rounded-full ring-1 ring-gray-500 px-2">
        ...
        <div className="flex item-center gap-6 justify-end w-full">
            ...
            <div className='flex flex-col items-center justify-center'>
                <span className="text-xs leading-3 font-medium"  >Neang Dara</span>
